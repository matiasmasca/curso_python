...
# def colision(objeto_1, objeto_2):
#    #print(objeto_1.left)
...
def direccion_aleatoria():
  posiblesDireccionesList = ['ARRIBA', 'ABAJO', 'IZQUIERA', 'DERECHA']
  print("random item from list is: ", random.choice(posiblesDireccionesList))
  return random.choice(posiblesDireccionesList)
...
rectangulo_2 = pygame.Rect(0, 150, 60, 60)
...
jugadorRect.topleft = (335, 150) # hubico la jugador
...
# Busca un evento
 ...
 # print(rectangulo.left)
  ...
  if jugadorRect.colliderect(rectangulo):
    print("hay colision")
    direccion = direccion_aleatoria()

  # hay colision?
  # if colision(rectangulo, rectangulo_2):
  #  direccion = "ARRIBA"



  # Dibuja el bloque en la superficie
  pygame.draw.rect(superficieVentana, BLANCO, rectangulo)
